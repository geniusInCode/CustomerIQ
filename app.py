...
async function loadML(){
  ...
  document.getElementById('abtest').innerHTML=`
    <div class="srow"><span class="sk">Premium AOV</span><span class="sv">₹${d.premium.mean.toLocaleString()}</span></div>
    <div class="srow"><span class="sk">Basic AOV</span><span class="sv">₹${d.basic.mean.toLocaleString()}</span></div>
